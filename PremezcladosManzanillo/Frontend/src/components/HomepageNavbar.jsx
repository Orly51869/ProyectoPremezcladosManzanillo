...
const HomepageNavbar = () => {
  ...
  return (
    <header className="w-full px-8 py-0 fixed top-0 bg-white dark:bg-dark-primary border-b border-gray-200 dark:border-gray-700 flex items-center justify-between z-50 shadow-md">
      {/* 1. Logo (Izquierda) */}
      <Link
        to="/"
      ...
      {/* 3. Acciones de Usuario, Buscador y Tema (Derecha) */}
